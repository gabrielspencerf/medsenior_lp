...
export const LocationsGrid: React.FC<LocationsProps> = ({ currentCity, onCitySelect, availableCities }) => {
  return (
          ...
          {availableCities.map((city, idx) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-full transition-all duration-300 cursor-pointer border ${isCurrent
